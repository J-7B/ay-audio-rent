    ...
    >
      <div className=" container mx-auto flex justify-between items-center">
        ...
        <div className="flex items-center sm:pr-0 lg:pr-[10%] ">
          <Logo alt="AY Audio Rental logo" className="w-9 h-9 sm:block hidden" />
          <p
            className={clsx(
              "text-[22px] font-semibold md:pr-0 cursor-pointer flex ml-2",
              {
                "text-black": !sticky && !isStickyBlue,
                "text-white": sticky,
                "text-white": isStickyBlue,
              }
            )}
          >
            AY&nbsp;<span className="sm:block hidden ">Audio Rental</span>
          </p>
        </div>
       
        {/* Desktop Links */}

        <ul className=" md:hidden sm:hidden xs:hidden lg:flex xl:flex flex-row w-full gap-0 justify-between space-x-3 text-[0.95rem] font-bold">
          {renderLinks()}
          <li>
            <Link to="/Contact">
              <button
