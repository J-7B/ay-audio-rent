...
const Contact = () => {
  ...
  return (
   ...
   <div className="relative text-center pt-[2.7rem]">
      ...
      <div className="relative mt-4.2 mx-auto my-70 w-[100%] flex flex-wrap items-baseline justify-between px-[7%]">
        {/* Flex-1 Section on the Left */}
        <div className="basis-[50%] px-[0.7451rem]  ">
          <form className="space-y-4  ">
            <div className="flex flex-row mx-auto ">
              <div className="mr-2 w-1/2">
                ...
                <input
                  type="text"
                  className="mt-1 block w-[15.35rem] h-[2.375rem] p-2  bg-light-blue border-[0.0625rem] border-solid rounded-[0.1875rem] border-pastel-blue"
                />
              </div>
              <div className="w-1/2">
                <label className="block text-sm font-medium text-cello">
